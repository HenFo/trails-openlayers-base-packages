...
function useInteractiveSelection(
    ...
    function selectionKindResolver(
        selectionKind: SelectionKind
    ...
    useEffect(() => {
        ...
        const controllerCls = selectionKindResolver(selectionKind);
        const interactionController = new controllerCls(
            map.olMap,
        ...
        interactionController.setActive(isActive);
        return () => {
